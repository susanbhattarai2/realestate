            ...
            <div className="flex flex-wrap items-center justify-between">
                ...
                <ul className="hidden lg:flex flex-wrap items-center font-recoleta text-[16px] xl:text-[18px] leading-none text-black">
                    <li className="mr-7 xl:mr-[40px] relative group py-[20px]">
                        ...
                        <a href="#" className="transition-all hover:text-secondary">Home</a>

                        
                    </li>
                    <li className="mr-7 xl:mr-[40px] relative group py-[20px]">

                        <a href="about.html" className="transition-all hover:text-secondary">About</a>


                    </li>
                    <li className="mr-7 xl:mr-[40px] relative group py-[20px]">

                        <a href="#" className="transition-all hover:text-secondary">Properties</a>
                        
                    </li>
                    <li className="mr-7 xl:mr-[40px] relative group py-[20px]">

                        <a href="#" className="transition-all hover:text-secondary">Contact</a>
                        
                    </li>
                   
                    <li className="mr-7 xl:mr-[40px] relative group py-[20px]">

                        <a href="#" className="transition-all hover:text-secondary">Blog</a>
                        

                    </li>
                    <li className="mr-7 xl:mr-[40px] relative group py-[20px]">

                        <a href="contact-us.html" className="transition-all hover:text-secondary">Service</a>

                    </li>
                </ul>

                <ul className="flex flex-wrap items-center">
                    <li className="sm:mr-5 xl:mr-[20px] relative group"><a href="#">
                ...
                ">
                            <li
                                ...
                                <a href="login.js"
                                    className="font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-t-[12px]">login</a>
                            </li>

                            <li
                                className="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                <a href="register.js"
                                    className="font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-b-[12px]">register</a>
                            </li>
