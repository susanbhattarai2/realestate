...
const Footer = () => {
  return (
    ...
    <div className="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
        <a href="index.html" className="block mb-[25px]">
            <img src="assets/images/logo/logo.svg" width="99" height="46"  alt="footer logo"/>
        </a>
        <p className="mb-[5px] xl:mb-[40px] max-w-[270px]">Properties are most budget friendly
            so you have are find opportunity is
            main responsibility to clients </p>
        <p className="text-sm hidden md:block">&copy; <a href="https://themeforest.net/user/hastech/portfolio" className="text-secondary">HasTech.</a> All Rights Reserved - Privacy Policy</p>
    </div>
    <div className="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
        <h3 className="font-recoleta font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">Information<span className="text-secondary">.</span></h3>
        <ul className="text-[16px] leading-none mb-[-20px]">
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="about.html">About us</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="properties-v2.html">Properties</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="#">Careers</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="#">Payment</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="blog-grid.html">Blog Post</a></li>
        </ul>
    </div>
    <div className="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
        <h3 className="font-recoleta font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">Support<span className="text-secondary">.</span></h3>
        <ul className="text-[16px] leading-none mb-[-20px]">
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="add-properties.html">Add Property</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="#">Terms & Conditions</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="#">Help line</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="agent.html">Our Agents</a></li>
            <li className="mb-[20px]"><a className="inline-block transition-all hover:text-secondary" href="#">features</a></li>
        </ul>
    </div>
    <div className="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
        <h3 className="font-recoleta font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">Address<span className="text-secondary">.</span></h3>
       <p>2104 Charmaine Lane
        Amarillo, New York</p>
        <ul className="inline-flex items-center justify-center mt-[20px]">
            <li className="first:ml-0 ml-[15px]"><a href="https://www.facebook.com/" className="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
            ...
            <li className="ml-[15px]"><a href="https://twitter.com/" className="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
            ...
            <li className="ml-[15px]"><a href="https://www.instagram.com/" className="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
        ...
        <p className="text-sm md:hidden mt-[20px]">&copy; <a href="https://themeforest.net/user/hastech/portfolio" className="text-secondary">HasTech.</a> All Rights Reserved - Privacy Policy</p>
    </div>
</div>
