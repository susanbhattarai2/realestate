  ...
  return (
    ...
    <div className="bg-[#F5F9F8] px-[20px] lg:px-[15px] xl:px-[35px] py-[50px] rounded-[8px] mb-[40px]">
        ...
        <form action="#" className="relative">
            <div className="relative mb-[25px] bg-white">
                ...
                <svg className="absolute top-1/2 -translate-y-1/2 z-[1] left-[20px] pointer-events-none" width="14"
                    ...
                    <path
                        ...
                        stroke="#016450" stroke-width="1.5" />
                </svg>
            </div>

            <div className="relative mb-[25px] bg-white">
                <svg className="absolute top-1/2 -translate-y-1/2 z-[1] left-[20px] pointer-events-none" width="13"
                    height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_928_754)">
                        <path d="M4.64311 0H0V4.64311H4.64311V0ZM3.71437 3.71437H0.928741V0.928741H3.71437V3.71437Z"
                            fill="#016450" />
                        <path
                            d="M8.35742 0V4.64311H13.0005V0H8.35742ZM12.0718 3.71437H9.28616V0.928741H12.0718V3.71437Z"
                            fill="#016450" />
                        <path d="M0 13H4.64311V8.35689H0V13ZM0.928741 9.28563H3.71437V12.0713H0.928741V9.28563Z"
                            fill="#016450" />
                        <path
                            d="M8.35742 13H13.0005V8.35689H8.35742V13ZM9.28616 9.28563H12.0718V12.0713H9.28616V9.28563Z"
                            fill="#016450" />
                        <path d="M6.96437 0H6.03563V6.03563H0V6.96437H6.03563V13H6.96437V6.96437H13V6.03563H6.96437V0Z"
                            fill="#016450" />
                    </g>
                    <defs>
            ...
            <div className="relative mb-[25px] bg-white">
                <svg className="absolute top-1/2 -translate-y-1/2 z-[1] left-[20px] pointer-events-none" width="16"
                    ...
                    <path
                        ...
                        stroke="#016450" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M8 4V12" stroke="#016450" stroke-width="1.5" stroke-linecap="round"
            ...
            <div className="relative mb-[25px] bg-white">
                <svg className="absolute top-1/2 -translate-y-1/2 z-[1] left-[20px] pointer-events-none" width="14"
                    height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.33268 4.66667H4.66602V9.33334H9.33268V4.66667Z" stroke="#016450" stroke-width="1.5"
    ...
    <div className="bg-[#f5f9f8] px-[20px] lg:px-[15px] xl:px-[35px] py-[50px] rounded-[8px] mb-[40px]">
        <h3 className="text-primary leading-none text-[24px] font-recoleta underline mb-[30px]">Featured Property<span
            className="text-secondary">.</span></h3>
        <div className="sidebar-carousel relative">
                ...
                <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                                ...
                                <div className="flex flex-wrap flex-col absolute top-5 right-5">
                                    <button
                                        className="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img
                                            ...
                                            height="10" alt="cameraicon"/>07</button>
                                    <button
                                        className="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img
                                            ...
                                            height="10" alt="cameraicon"/>08</button>
                                </div>

                            </div>

                            <div className="pt-[15px] pb-[20px] px-[20px] text-left">
                                <h3><Link to="properties-details.html" className="font-recoleta leading-tight text-[16px] text-primary">Orchid
                                        Casel de
                                        Paradise.</Link></h3>
                                <h4><Link to="properties-details.html" className="font-light text-[14px] text-secondary underline">18B Central
                                        Street,
                                        San Francisco</Link></h4>
                                <ul className="mt-[10px]">
                                    <li className="flex flex-wrap items-center justify-between">
                                        <span className="font-recoleta text-[14px] text-primary leading-none">Price:
                                            $255300</span>
                        ...
                        <div
                            ...
                            <div className="pt-[15px] pb-[20px] px-[20px] text-left">
                                <h3><Link to="properties-details.html" className="font-recoleta leading-tight text-[16px] text-primary">Sindrela
                                        Resort Villa.</Link></h3>
                                <h4><Link to="properties-details.html" className="font-light text-[14px] text-secondary underline">18B Central
                                        Street,
                                        San Francisco</Link></h4>
                                <ul className="mt-[10px]">
                                    <li className="flex flex-wrap items-center justify-between">
                                        <span
                                            className="font-recoleta text-[14px] text-primary leading-none">Price:$185300</span>
            ...
            <div className="flex flex-wrap items-center justify-center mt-[25px]">
                ...
                <div
                    className="swiper-button-next w-[26px] h-[26px] rounded-full bg-primary  text-white hover:bg-secondary static mx-[5px] mt-[0px]">
                </div>
