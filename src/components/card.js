    ...
    <div className="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
        <div className="relative">
            <a href="properties-details.html" className="block">
                <img src={propertyimage} className="w-full h-full" loading="lazy" width="370" height="266" alt="@@title"/>
            </a>
            ...
            <div className="py-[20px] px-[20px]">
                <h3><a href="properties-details.html" className="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Elite Garden Resedence.</a></h3>
                <h4><a href="properties-details.html" className="font-light text-tiny text-secondary underline">253 Montril Street, South Town, Lalitpur</a></h4>
