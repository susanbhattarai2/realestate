...
//import shape from "../assets/video/shape.png"
import star from "../assets/video/star.png"
const Video = () => {
  return (
    <>
...
<div className="grid grid-cols-12 gap-[30px] items-center">
    <div className="col-span-12 lg:col-span-6 relative">
        <div className="mb-5 lg:mb-0 max-w-[450px]">
            ...
            <h2 className="font-recoleta text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[10px]">Watch the video for taking your decision easily <span className="text-secondary">.</span></h2>
            <p>Huge number of propreties availabe here for buy, sell and 
                ...
                <img  className="absolute bottom-[-18px] right-[5px]" src={star} loading="lazy" width="65" height="73" alt="image"/>
               
        </div>
    </div>
    <div className="col-span-12 lg:col-span-6 text-center">
        <div className="relative p-[20px] lg:p-[30px] bg-[#ECFAF7] inline-block rounded-[24px]">
            <div className="scene drop-shadow-[0px_10px_20px_rgba(0,0,0,0.25)]" data-relative-input="true">
                <img data-depth="0.1" src={video} className="rounded-[24px]" loading="lazy" width="507" height="349" alt="video image"/>
            </div>
            <a  href="https://www.youtube.com/watch?v=mSC6GwizOag" className="play-button bg-white text-white hover:text-primary absolute left-0 right-0 mx-auto top-1/2 -translate-y-1/2 hover:scale-105 hover:bg-primary w-[55px] h-[55px] flex 
